...
import PageCarousel from "@/components/pages/PageCarousel.vue";
...
<template>
  ...
  <section class="About">
    ...
    <div class="About__book"><img src="@/assets/images/about-book.png" alt="本書の表紙の画像。" /></div>
  ...
  <PageCarousel :carouselData="carouselAboutData" />
